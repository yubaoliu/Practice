 ...
 * @create date 2019-07-24 11:06:27
 * @modify date 2019-07-24 11:06:27
 * @desc [description]
 */
...
int main(int argc, char **argv)
{
    ...
    //设置角点检测参数
    std::vector<cv::Point2f> lastImgCorners_v;
    ...
    //     cv::goodFeaturesToTrack(lastImage, lastImgCorners_v, max_corners, quality_level, min_distance, cv::Mat(), block_size, true, k);
    //     // f.ProcessMovingObject(lastImage);
    // }
